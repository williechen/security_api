...
COMMENT ON COLUMN security_temp.open_date_year IS '開市日期_年';
COMMENT ON COLUMN security_temp.open_date_month IS '開市日期_月';
COMMENT ON COLUMN security_temp.open_date_day IS '開市日期_日';
